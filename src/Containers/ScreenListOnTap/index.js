                                ...
                                <div className="carousel slide" id="myCarousel">
                                    <dl className="thumbnails">
                                        <dd className="col-sm-3">
                                            <div className="fff">
                                                <div className="thumbnail">
                                                    <a href="#"><img src="http://sv1.upsieutoc.com/2017/04/05/anh_sa_hinh.jpg" alt=""/></a>
                                                </div>
                                        ...
                                        <dd className="col-sm-3">
                                            <div className="fff">
                                                <div className="thumbnail">
                                                    <a href="#"><img src="http://sv1.upsieutoc.com/2017/04/05/anh_bien_bao.png" alt=""/></a>
                                                </div>
                                                <div className="caption">
                                                    <h4>Phần biển báo</h4>
                                                    <p>Nullam Condimentum Nibh Etiam Sem</p>
                                        ...
                                        <dd className="col-sm-3">
                                            <div className="fff">
                                                <div className="thumbnail">
                                                    <a href="#"><img src="http://sv1.upsieutoc.com/2017/04/05/anh_ly_thuyet.jpg" alt=""/></a>
                                                </div>
                                                <div className="caption">
